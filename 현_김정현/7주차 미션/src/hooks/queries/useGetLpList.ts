...
function useGetLpList({cursor, search,order, limit}: PaginationDto) {
    return useQuery({
        ...
        // 데이터가 신선하다고 간주하는 시간
        // 이 시간 동안은 캐시된 데이터 그대로 사용. 컴포넌트가 마운트되거나 창에 포커스 들어오는 경우에도 재요청X
        ...
        // 그 이후 해당 쿼리가 전혀 사용되지 않으면 gcTime이 지난 후 제거 (garbage collection)
        ...
        // 기본값은 3회 정도, 네트워크 오류 등 일시적인 문제를 보완할 수 있다.
        // retry: 3,
        ...
        // 파라미터가 변경될 떄 이전 데이터를 유지하여 UI 깜빡임(Flicking)을 줄여줌
