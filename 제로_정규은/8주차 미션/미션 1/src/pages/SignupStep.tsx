        ...
        {step === 3 && (
          <div className="flex flex-col gap-3 items-center">
            ...
            <button
              ...
              className="bg-[#96c0f0] text-white w-full py-3 p-[10px] rounded-sm text-lg hover:bg-[#FF1493]/80 transition-colors duration-200 cursor-pointer disabled:bg-gray-300"
            >
              회원가입 완료
            </button>
          </div>
