...
const MovieDetailPage=(): React.ReactElement => {
    ...
    <>
        ...
        >
            <div className="absolute inset-0 bg-black/60 flex flex-col justify-between p-6 text-white">
                
                <div>
                    <p className="mb-1"><strong>개봉일:</strong> {movie?.release_date}</p>
                    <p className="mb-1"><strong>런타임:</strong> {movie?.runtime}분</p>
                    <p className="mb-4"><strong>평점:</strong> {movie?.vote_average}</p>
                    <p className="mb-1"><strong>줄거리:</strong>{movie?.overview}</p>
                </div>
                <div>
